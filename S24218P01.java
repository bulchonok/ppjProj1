...
/*
                    READ ME:
Input w formie "Wileka litera + enter + koordynata x[1;8]

po biciu jest zaproszone czy jeszcze jest mozliwość bicia(proszę odpowiadać prawdziwie)
jesli odpowiedź "yes", masz 3 szansy do bicia następnej warcaby.

            koniec gry:
1.po pięciu ruchach bez bicia jest zapytanie o remisie(po odpowiedzi nie pojawią się po 5 ruchach bez bicia
2.kiedy pozastają się tylko warcaby jednego kolora, gracz wygrywa
...
//
            ...
            if (!isBeated){
                DrawCounter++;
                if (DrawCounter>=5){
                    System.out.println("do you agree on a draw?\n1: Yes / 2: No");
                switch (scannerInt.nextInt()){
                    case 1 -> {
                        System.out.println("""
                                ------
